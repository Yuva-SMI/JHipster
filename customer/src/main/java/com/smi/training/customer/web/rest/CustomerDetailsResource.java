...
import com.smi.training.customer.service.CustomerDetailsService;
...
/**
 * REST controller for managing {@link com.smi.training.customer.domain.CustomerDetails}.
 */
@RestController
@RequestMapping("/api")
public class CustomerDetailsResource {
    ...
    private static final String ENTITY_NAME = "customerCustomerDetails";
