package com.smi.training.notification.web.rest;

import com.smi.training.notification.NotificationApp;
import com.smi.training.notification.domain.Notification;
import com.smi.training.notification.repository.NotificationRepository;
...
import com.smi.training.notification.domain.enumeration.NotificationType;
/**
...
public class NotificationResourceIT {
    ...
    private static final Long DEFAULT_GRIENVANCE_ID = 1L;
    private static final Long UPDATED_GRIENVANCE_ID = 2L;
    ...
    public static Notification createEntity() {
        Notification notification = new Notification()
            ...
            .grienvanceId(DEFAULT_GRIENVANCE_ID);
        return notification;
    }
    /**
    ...
    public static Notification createUpdatedEntity() {
        Notification notification = new Notification()
            ...
            .grienvanceId(UPDATED_GRIENVANCE_ID);
        return notification;
    }
    ...
    public void createNotification() throws Exception {
        ...
        assertThat(testNotification.getGrienvanceId()).isEqualTo(DEFAULT_GRIENVANCE_ID);
    }
    ...
    @Test
    public void checkGrienvanceIdIsRequired() throws Exception {
        int databaseSizeBeforeTest = notificationRepository.findAll().size();
        // set the field null
        notification.setGrienvanceId(null);
    ...
    public void getAllNotifications() throws Exception {
        ...
        restNotificationMockMvc.perform(get("/api/notifications?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].grienvanceId").value(hasItem(DEFAULT_GRIENVANCE_ID.intValue())));
    }
    ...
    public void getNotification() throws Exception {
        ...
        restNotificationMockMvc.perform(get("/api/notifications/{id}", notification.getId()))
            ...
            .andExpect(jsonPath("$.grienvanceId").value(DEFAULT_GRIENVANCE_ID.intValue()));
    }
    ...
    public void updateNotification() throws Exception {
        ...
        assertThat(testNotification.getGrienvanceId()).isEqualTo(UPDATED_GRIENVANCE_ID);
    }
