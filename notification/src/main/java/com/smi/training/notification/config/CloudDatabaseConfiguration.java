package com.smi.training.notification.config;
...
@Configuration
@EnableMongoRepositories("com.smi.training.notification.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("com.smi.training.notification.config.dbmigrations");
